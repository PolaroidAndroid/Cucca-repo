...
#vediamo che esiste un'enorme variabilità sia per il peso del corpo che per la dimensione del cervello, d'altronde stiamo osservando un insieme di animali che vanno dall'elefante africano al topo 
...
#dev.off()
#su scala log-log la relazione lineare è molto evidente
...
#dev.off()
#### verifichiamo la normalità su scala log-log
...
### elaboriamo il modello di regressione e verifichiamo la bontà di adattamento
